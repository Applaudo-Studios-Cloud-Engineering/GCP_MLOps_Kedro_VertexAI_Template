...
# kedro_experiment documentation build
...
from kedro_experiment import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_experiment"
author = "Kedro"
...
htmlhelp_basename = "kedro_experimentdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_experiment.tex",
        "kedro_experiment Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_experiment",
        "Project kedro_experiment codebase.",
        "Nearest-Neighbour",
    )
]
